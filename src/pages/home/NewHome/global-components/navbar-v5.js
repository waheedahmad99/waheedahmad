		...
		<div>
			...
			<header className="ltn__header-area ltn__header-3 section-bg-6---">        
				...
				<div className="container">
					...
					<div className="col">
						...
						<Link to="/"><img  style={{width :"70%"}} src={"https://equityandhelp.com/wp-content/uploads/2022/02/EasyHomes.png"} alt="Logo" /></Link>
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					<div className="ltn__utilize-menu-head">
					<div className="site-logo">
						<Link to="/"><img  className="mt-n4" style={{width :"70%"}} src={"https://calleasyhomes.com/web/image/res.company/1/logo?unique=40261c8"} alt="Logo" /></Link>
					</div>
					<button className="ltn__utilize-close">×</button>
					</div>
