    ...
    return <div className="ltn__shop-details-area pb-10">
				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						<h1>{this.props.property.street}</h1>
						<div className="ltn__blog-meta">
						<ul>
							<li className="ltn__blog-category">
							<label><span className="ltn__secondary-color"><i className="flaticon-pin" /></span> {this.props.property.city}, {this.props.property.state}</label>
							</li>
							<li className="ltn__blog-category">
						...
						<h4 className="title-2">{this.props.property.property_description?"Description":''}</h4>
						<p>{this.props.property.property_description}</p>
						<h4 className="title-2">Property Detail</h4>  
						<div className="property-detail-info-list section-bg-1 clearfix mb-60">                          
						<ul>
							<li><label>Property ID:</label> <span>HZ29</span></li>
							<li><label>Home Area: </label> <span>{this.props.property.square_footage}</span></li>
							<li><label>Rooms:</label> <span>7</span></li>
							<li><label>Baths:</label> <span>{this.props.property.baths}</span></li>
						...
						<ul>
							...
							<li><label>Beds:</label> <span>{this.props.property.beds}</span></li>
							<li><label>Price:</label> <span>{this.props.property.eh_list_price}</span></li>
						...
						src={`https://www.google.com/maps/embed/v1/place?q=${ this.props.property.street ? this.props.property.street : '' },${ this.props.property.city ?this.props.property.city : '' }+USA&key=${GOOGLE_MAP_API_KEY}`}
					...
					<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
						...
						<h4 className="ltn__widget-title ltn__widget-title-border-2">Send Message To EasyHomes</h4>
						<form action="#">
