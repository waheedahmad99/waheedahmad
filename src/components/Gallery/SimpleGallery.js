...
const SimpleGallery = (props) => {
   ...
   let itemVariant;
   if (images) itemVariant = 'images';
   else if (texts) itemVariant = 'texts';
   else itemVariant = 'videos';
   const [lightboxIsOpen, setLightboxIsOpen] = useState(false);
   const [currentItem, setCurrentItem] = useState(startIndex);
               ...
               .map((obj, i) => {
                  return (
                     <a
                        ...
                        className={css(
                           classes.thumbnail,
                           classes[obj.orientation]
                        )}
                        onClick={e => openLightbox(e, startIndex)}
                        key={i}
                     >
                        <div className="img-thumbnail" style={{width: 200,height: 150,}}>
                           <img
                              src={obj.thumbnail}
