...
const BillsTabView = props => {
    ...
    const defaultColDef = {
      ...
      const getList = async() => {
       const data=await Bills.getBillsForTrust(props.id)
    ...
    return (
        <React.Fragment>
            <Card.Header>
                ...
                <BillEstimateModal id={props.id && props.id} toggle={ toggle } setToggle={ setToggle } />
                <BillPaymentModal id={props.id && props.id} toggle={ toggle } setToggle={ setToggle } />
                <BillAddFundsModal id={props.id && props.id} toggle={ toggle } setToggle={ setToggle } />
