			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" /> info@Calleasyhomes.com</a></li>
						<li><a href="locations.html"><i className="icon-placeholder" /> 600 Cleveland St, Clearwater, FL 33755</a></li>
						</ul>
					</div>
					</div>
			...
			<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
				...
				<div className="row">
					...
					<div className="site-logo-wrap">
						...
						<Link to="/user/"><img  style={{width :"70%"}} src={"https://equityandhelp.com/wp-content/uploads/2022/02/EasyHomes.png"} alt="Logo" /></Link>
						</div>
						...
						<div className="get-support-info">
							<h6>Get Support</h6>
							<h4><a href="tel:+123456789">(844)552-8828</a></h4>
						</div>
						</div>
					</div>
					</div>
					...
					<div className="header-menu d-none d-xl-block">
						...
						<div className="ltn__main-menu go-top">
							...
							<li className=""><Link to="/about">About</Link>
							</li>
							<li className=""><Link to="/shop">Shop</Link>
							</li>
							<li className=""><Link to="/blog-grid">News</Link>
							</li>
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<div className="site-logo">
						<Link to="/"><img  src={"https://equityandhelp.com/wp-content/uploads/2022/02/EasyHomes.png"} alt="Logo" /></Link>
					</div>
